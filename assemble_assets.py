...
def main():
    ...
    # Remove banner-light.svg if it exists as it is no longer used
    if os.path.exists("banner-light.svg"):
        try:
            os.remove("banner-light.svg")
            print("Removed obsolete banner-light.svg.")
        except Exception as e:
            print(f"Warning: Could not remove banner-light.svg: {e}")
